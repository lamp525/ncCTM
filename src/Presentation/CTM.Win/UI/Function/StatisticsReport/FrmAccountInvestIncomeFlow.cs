...
namespace CTM.Win.UI.Function.StatisticsReport
{
    public partial class FrmAccountInvestIncomeFlow : BaseForm
    {
        ...
        private void GetSearchResult()
        {
            ...
            //选择的帐户信息
            var selectedAccount = this.luAccount.GetSelectedDataRow() as AccountInfoModel;
            ...
            {
                accounts = this.luAccount.Properties.DataSource as List<AccountInfoModel>;
