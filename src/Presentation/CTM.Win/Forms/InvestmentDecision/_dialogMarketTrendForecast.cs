...
{
    public partial class _dialogMarketTrendForecast : BaseForm
    {
        #region Fields
        ...
        public _dialogMarketTrendForecast(ICommonService commonService, IInvestmentDecisionService IDService)
        {
            InitializeComponent();
        ...
        private void BindTrendDailyInfo()
        {
            ...
            var commandText = $@"EXEC [dbo].[sp_GetMarketTrendForecastDetail]
                                            @SerialNo ='{SerialNo}'";
        ...
        private void _dialogMarketTrendForecast_Load(object sender, EventArgs e)
        {
            try
            {
                FormInit();
